...
vim.api.nvim_set_keymap('n', '<C-e>t', ':tabnew | NvimTreeOpen<CR><C-W>l:q<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('i', '<C-e>t', '<Esc>:tabnew | NvimTreeOpen<CR><C-W>l:q<CR>', { noremap = true, silent = true })
